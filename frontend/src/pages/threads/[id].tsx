...
import { Lock, MessageCircle, Clock, User, ArrowLeft } from "lucide-react"
          ...
          <div className="mt-8">
            ...
            {repliesLoading ? (
              ...
              <div className="text-center py-8 bg-slate-50 rounded-lg border border-slate-200">
                ...
                <Button className="mt-4" disabled={thread.is_locked}>
                  {thread.is_locked ? "Thread is locked" : "Reply to thread"}
                </Button>
              </div>
            )}
          </div>

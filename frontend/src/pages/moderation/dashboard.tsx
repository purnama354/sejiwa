      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {cards.map((c) => {
          ...
          return (
            <div
              key={c.label}
              className="relative overflow-hidden rounded-xl bg-white/70 backdrop-blur-sm border border-slate-200/60 p-6 shadow-lg"
            >
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`w-12 h-12 rounded-lg bg-gradient-to-r ${c.color} flex items-center justify-center shadow-lg`}
                >
      ...
      <div className="rounded-xl bg-white/70 backdrop-blur-sm border border-slate-200/60 p-6 shadow-lg">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <Stat
            ...
            value={stats?.average_response_time_hours ?? 0}
          />
